...
void reconnect() {
  while (!client.connected()) {
    ...
    if (client.connect("G.231.22.0006", "usm", "usmjaya001")) {
      Serial.println("Connected!");
      client.subscribe("g231220006/temperature");
      client.subscribe("g231220006/humidity");
      client.subscribe("g231220006/control");
    } else {
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (String(topic) == "g231220006/control") {
...
void publishTemp() {
  ...
  client.publish("g231220006/temperature", tempString, true);

  char humString[8];
  dtostrf(humidity, 1, 2, humString);
  client.publish("g231220006/humidity", humString, true);
}
